...
1. Naive shrinkage: $$\Psi_{naive} = \left(1-\dfrac{1}{N_0}) R_0\right) + \dfrac{1}{N_0} I$$

2. Wen and Stephens (2010) shrinkage: 
$$\Psi_{WS} = \left(1- \lambda\right)^2 R_0 + (1 - (1-\lambda)^2) I,$$ 
...
3. Ledoit and Wolf (2004) linear shrinkage: 
$$\Psi_{linear-LW} = \left(1- \lambda\right) R_0 + \lambda I,$$ 
where $\lambda$ is estimated by minimizing the MSE between $\Psi$ and the true unknown $\Psi$ (similar approach to James-Stein shrinkage). The result $\lambda \asymp \dfrac{1}{N_0}$.
