...
```{r}
sum((R_q[set_rows[1], ] - R_bar[set_rows[1], ])^2)
sum((R_q[set_rows[2], ] - R_bar[set_rows[2], ])^2)
sum((R_q[set_rows[3], ] - R_bar[set_rows[3], ])^2)
sum((R_q[set_rows[4], ] - R_bar[set_rows[4], ])^2)
sum((R_q[set_rows[5], ] - R_bar[set_rows[5], ])^2)
